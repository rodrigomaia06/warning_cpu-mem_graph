...
echo "Installing Dependencies ......"; wget -q https://raw.githubusercontent.com/rodrigomaia06/warning_cpu-mem_graph/main/versions/1.0/dependencies.sh; chmod +x dependencies.sh;  bash dependencies.sh &> /dev/null
